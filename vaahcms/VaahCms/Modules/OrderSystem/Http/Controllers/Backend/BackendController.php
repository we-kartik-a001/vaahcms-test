...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-ordersystem';
        ...
        */
        ...
        return view('ordersystem::backend.pages.app');
...
//        $steps[] = $this->isSetupComplete();
        ...
        $data['module'] = [
            'name' => config('ordersystem.name'),
            'version' => config('settings.global.ordersystem_version')??config('ordersystem.version'),
            'is_dev' => config('ordersystem.is_dev'),
            'setup' => [
                'steps' => $steps
            ]
        ];
