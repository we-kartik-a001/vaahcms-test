<?php namespace VaahCms\Modules\BlogSystem\Http\Controllers\Backend;
...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-blogsystem';
        ...
        */
        ...
        return view('blogsystem::backend.pages.app');
...
//        $steps[] = $this->isSetupComplete();
        ...
        $data['module'] = [
            'name' => config('blogsystem.name'),
            'version' => config('settings.global.blogsystem_version')??config('blogsystem.version'),
            'is_dev' => config('blogsystem.is_dev'),
            'setup' => [
                'steps' => $steps
            ]
        ];
